...
4. **Visualize interactively** — [Dashboard](dashboard/index.html) is a self-contained (no external dependencies) HTML dashboard with a toggleable monthly trend line, a stacked category-by-store bar, a Pareto ranking, and the headline Cork finding, built to be hosted directly on GitHub Pages.
